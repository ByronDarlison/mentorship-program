...
const history=period=>[6,9,12].includes(period)?{history:{countFrom:'{{meeting_count_start_date}}',fromStart:false,previousUnanswered:null,lastReport:{date:'{{previous_report_date}}',period:period-3,answers:{meetings:'{{previous_meeting_count}}',value:'{{previous_feedback}}',contact:'{{previous_contact_answer}}'}}}}:{};
